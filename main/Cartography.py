...
class Cartography(BotReaction):
    ...
    def __init__(self, mudReaderHandler, commandHandler):
        ...
        #super(Inventory, self).__init__([self.you_have, self.wont_buy, self.sold, self.dropped, self.not_a_pawn_shop])
    ...
    def notify(self, regex, M_obj):
        ...
        #elif regex == self.not_a_pawn_shop:

        self.__waiter_flag = True
        magentaprint(self.inventory)
    ...
    def parse_inventory_list(self, inventory_string):
        ...
        # inv_list = [item[2:] if item[0:2] == "a " for item in inv_list]
        # inv_list = [item[3:] if item[0:3] == "an " for item in inv_list]
        # inv_list = [item[5:] if item[0:5] == "some "for item in inv_list]
    ...
    def sellable(self):
        ...
        magentaprint("")
        magentaprint(numbered_references)
