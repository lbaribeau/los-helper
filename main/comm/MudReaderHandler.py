...
#       return self.MudReaderThread.MONSTER_LIST
    ...
    def start_recording_mud_text(self):
        self.mudReaderThread.start_recording_mud_text()

    def stop_recording_mud_text(self):
        self.mudReaderThread.stop_recording_mud_text()
        r = self.mudReaderThread.recorded_text
        self.mudReaderThread.recorded_text=''
        return r
