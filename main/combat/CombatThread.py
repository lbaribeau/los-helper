...
# Erhm this does not get used in favor of CombatObject/ThreadingMixin
...
class CombatThread(threading.Thread):
    ...
    def notify(self, regex, M_obj):
        ...
        self.stop()
        # TBD: This thread isn't getting stopped when someone in your party kills the mob...
        # TDB: when a party member flees the combat threads should not stop.
